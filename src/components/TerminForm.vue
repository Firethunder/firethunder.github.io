...
<template>
    <div class="bg-white p-6 shadow-sm border border-slate-200 rounded-xl mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-7 gap-4">
        ...
        <div class="flex flex-col gap-1">
          <label class="text-sm font-semibold text-slate-500 ml-1">Name</label>
        ...
        <div class="flex flex-col gap-1">
          <label class="text-sm font-semibold text-slate-500 ml-1">Veranstalter</label>
        ...
        <div class="flex flex-col gap-1">
          <label class="text-sm font-semibold text-slate-500 ml-1">Gruppe</label>
        ...
        <div class="flex flex-col gap-1">
          <label class="text-sm font-semibold text-slate-500 ml-1">Ort</label>
          <InputText v-model="newTermin.ort" placeholder="Brittheim..." fluid />
        </div>
        <div class="flex flex-col gap-1">
          <label class="text-sm font-semibold text-slate-500 ml-1">Dauer (Min)</label>
          <InputText v-model="newTermin.dauer" type="number" placeholder="120" fluid />
        </div>
        <div class="flex items-end">
          <Button label="Hinzufügen" icon="pi pi-plus" @click="$emit('add-termin')" fluid class="h-10 font-bold" />
        </div>
      </div>
    </div>
</template>
